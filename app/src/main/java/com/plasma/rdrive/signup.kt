...
//        Reference
        val login = findViewById<Button>(R.id.send_otp_phone)
...
//        Reference
        val verify=findViewById<Button>(R.id.submit_phone)
        val otpGiven=findViewById<EditText>(R.id.otp_phone)
    ...
    private fun login() {
        ...
        var number = phone_text.text.toString().trim()
